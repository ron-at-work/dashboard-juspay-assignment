      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <button 
            ...
            className="p-2 border border-dashboard-border rounded-lg hover:bg-dashboard-bgSecondary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
              ...
              <button
                ...
                className={`px-3 py-1 text-sm rounded-lg transition-colors ${
                  pageNum === currentPage
                    ...
                    : 'text-dashboard-textSecondary hover:bg-dashboard-bgSecondary'
                }`}
              >
                {pageNum}
              </button>
